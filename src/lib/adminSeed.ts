import { checkSuperAdminExists, createInitialSuperAdmin } from './adminAuthService'
...
export async function seedInitialAdmin() {
  ...
  try {
    ...
    console.log(`[SEED] Successfully created initial Super Admin: ${defaultSuperAdmin.email}`)
  } catch (err) {
